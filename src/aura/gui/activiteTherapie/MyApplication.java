...
public class MyApplication {
  ...
  private Form main;
    private Coord lastLocation; public static User user;
    ...
    public void start(Form previous,String username) {
        ...
        showMeOnMap(previous,username);

    }

    private void showMeOnMap(Form previous,String username) {
        
        Form map = new Form("Map");
        Toolbar tb =map.getToolbar();
            Form formm = new Listact(previous,username);
    ...
    private void putMeOnMap(MapComponent map) {
        try {
            ...
            PointsLayer pl = new PointsLayer();
            pl.setPointIcon(i);
            PointLayer p = new PointLayer(lastLocation, "ICI", i);
