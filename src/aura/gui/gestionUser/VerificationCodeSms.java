 ...
 * @author SeifBS
 */
public class VerificationCodeSms extends Form {
    ...
    public VerificationCodeSms(Form previous,String username) {
        ...
        verifier.addActionListener((e) -> {
            ...
            if (!verificationCode.getText().equals(HomeForm.verificationCode)) {
                tentative++;
                ...
                Dialog.show("Sucees", "Code correct", new Command("OK"));
                 try {
                         HomeClient homeClient = new HomeClient( this.username);
                        homeClient.show();
                    } catch (IOException ex) {
                        ex.printStackTrace();
                    }
